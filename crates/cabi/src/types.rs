...
pub struct IGCodecApi {
    ...
    pub can_handle_extension: Option<unsafe extern "C" fn(*const IGCodecApi, *const u16, i32) -> i32>,
    pub can_handle_signature: Option<unsafe extern "C" fn(*const IGCodecApi, *const u8, i32) -> i32>,
    pub load_metadata:
        Option<unsafe extern "C" fn(*const IGCodecApi, *const IGStringRef, *mut IGImageInfo) -> IGStatus>,
    ...
    >,
    pub free_pixel_buffer: Option<unsafe extern "C" fn(*const IGCodecApi, *mut IGPixelBuffer) -> IGStatus>,
}
