...
> **Note**: This retrospective documents the C# development phase. The Rust port (v0.1.0 to v0.3.0) follows different patterns documented in STANDARDS.md and docs/adr/.
...
- **AGENTS.md** — maintenance liability, code + README are sufficient for AI agents
